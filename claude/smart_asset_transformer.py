...
def main():
    ...
    # Configuration
    INPUT_PATH = "D:/Datanodes_Assignment/claude/claude_outputs/lady/4548556.psd"  # Change to your input
    OUTPUT_DIR = "D:/Datanodes_Assignment/claude/claude_outputs/lady"
